<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="practical11-1.aspx.cs" Inherits="WebApplication1.practical11_1" %>
...
<body>
    <form id="form1" runat="server">
          <table>
            ...
            <tr>
                <td>
                    <asp:Label runat="server" ID="Label2" Text="enter your email"></asp:Label>
                </td>
                <td>
